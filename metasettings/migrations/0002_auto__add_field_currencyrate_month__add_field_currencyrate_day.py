...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CurrencyRate.day'
        db.add_column(u'metasettings_currencyrate', 'day',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'CurrencyRate.day'
        db.delete_column(u'metasettings_currencyrate', 'day')
    ...
    models = {
        u'metasettings.currencyrate': {
            ...
            'day': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
